...
function jsAngular() {
	return gulp.src([path.jsAngular.src + 'core/app-setup/app.module.js', path.jsAngular.src + '**/*.js', '!' + path.jsAngular.src + 'core/OAUTHCLIENTS.SAMPLE.constant.js', '!' + path.jsAngular.src + 'ng-app.js'])
		.pipe(sourcemaps.init())
